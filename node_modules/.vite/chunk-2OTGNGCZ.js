...
var stack, ErrorTypeStrings, isFlushing, isFlushPending, queue, flushIndex, pendingPreFlushCbs, activePreFlushCbs, preFlushIndex, pendingPostFlushCbs, activePostFlushCbs, postFlushIndex, resolvedPromise, currentFlushPromise, currentPreFlushParentJob, RECURSION_LIMIT, getId, isHmrUpdating, hmrDirtyComponents, map, devtools, devtoolsComponentAdded, devtoolsComponentUpdated, devtoolsComponentRemoved, devtoolsPerfStart, devtoolsPerfEnd, deprecationData, instanceWarned, warnCount, currentRenderingInstance, currentScopeId, withScopeId, accessedAttrs, getChildRoot, getFunctionalFallthrough, filterModelListeners, isElementRoot, isSuspense, SuspenseImpl, Suspense, hasWarned, INITIAL_WATCHER_VALUE, TransitionHookValidator, BaseTransitionImpl, BaseTransition, isAsyncWrapper, isKeepAlive, KeepAliveImpl, KeepAlive, createHook, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onServerPrefetch, onRenderTriggered, onRenderTracked, shouldCacheAccess, internalOptionMergeStrats, isSimpleType, isInternalKey, normalizeSlotValue, normalizeSlot, normalizeObjectSlots, normalizeVNodeSlots, initSlots, updateSlots, isBuiltInDirective, uid2, hasMismatch, isSVGContainer, isComment, supported, perf, queuePostRenderEffect, setRef, isTeleport, isTeleportDisabled, isTargetSVG, resolveTarget, TeleportImpl, Teleport, COMPONENTS, DIRECTIVES, NULL_DYNAMIC_COMPONENT, Fragment, Text, Comment$1, Static, blockStack, currentBlock, isBlockTreeEnabled, vnodeArgsTransformer, createVNodeWithArgsTransform, InternalObjectKey, normalizeKey, normalizeRef, createVNode, getPublicInstance, publicPropertiesMap, PublicInstanceProxyHandlers, RuntimeCompiledPublicInstanceProxyHandlers, emptyAppContext, uid$1, currentInstance, getCurrentInstance, setCurrentInstance, isBuiltInTag, isInSSRComponentSetup, compile, isRuntimeOnly, attrHandlers, classifyRE, classify, ssrContextKey, useSSRContext, version, ssrUtils, resolveFilter, compatUtils;
...
`;
  ...
  (This can also be done per-component via the "compatConfig" option.)`,
    ...
    setRef = (rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) => {
      if (isArray(rawRef)) {
...
//# sourceMappingURL=chunk-2OTGNGCZ.js.map
