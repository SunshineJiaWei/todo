...
var Swiper = function() {
  ...
  Swiper3.installModule = function installModule(module) {
    if (!Swiper3.prototype.modules)
      Swiper3.prototype.modules = {};
    var name = module.name || Object.keys(Swiper3.prototype.modules).length + "_" + now();
    Swiper3.prototype.modules[name] = module;
  };
  Swiper3.use = function use(module) {
      ...
      if (!ignoreWheelEvents) {
        ...
        if (swiper.params.freeModeSticky) {
          ...
          if (_prevEvent && (_newEvent.delta > _prevEvent.delta || _newEvent.direction !== _prevEvent.direction)) {
            ...
            _recentWheelEvents.splice(0);
            swiper.mousewheel.timeout = nextTick2(function() {
...
function getParams(obj) {
  ...
  var passedParams = {};
  extend3(params, core_class_default.defaults);
  extend3(params, core_class_default.extendedDefaults);
...
function renderLoop(swiperRef, slides, swiperParams) {
  ...
  function duplicateSlide(child, index2, position) {
    if (!child.props)
      child.props = {};
    return h(child.type, _extends2({}, child.props, {
...
function renderVirtual(swiperRef, slides, virtualData) {
  ...
  return slides.filter(function(slide, index2) {
    ...
    return h(slide.type, _extends3({}, slide.props), slide.children);
  });
}
...
var Swiper2 = {
  ...
  setup: function setup(props, _ref) {
    var originalSlots = _ref.slots, emit2 = _ref.emit;
    ...
    swiperParams.onAny = function(event2) {
      ...
      emit2.apply(void 0, [event2].concat(args));
    };
